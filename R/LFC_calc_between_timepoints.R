#' Calculate Log Fold Changes (LFC) Between Time Points
#'
#' This function calculates the log fold changes for each gene between specified
#' time points, using expression data with or without replicates.
#'
...
#' @return A data frame containing the LFCs for all pairs of time points.
...
LFC_calc_between_timepoints <- function(data, timepoints, is_log_transformed = FALSE) {
